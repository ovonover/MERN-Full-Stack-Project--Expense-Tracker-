...
import CARD_2 from '../../assets/images/card_3.png'
...
const AuthLayout = ({children}) => {
  return <div className='flex'>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative z-10' >
            ...
            <div className='w-48 h-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-60' />
